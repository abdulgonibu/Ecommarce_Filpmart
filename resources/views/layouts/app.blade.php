                    ...
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            ...
                            <li class="has-child-item close-item {{ request()->is('category/*') ? 'open-item': '' }}">
                                ...
                                <ul class="nav child-nav level-1">
                                    <li class="{{ request()->is('category/manage-category', 'category/edit/*') ? 'active-item': '' }}"><a href="{{ route ('manage-category')}}">Category</a></li>
...
<script src="{{ asset('/') }}/assets/admin/avascripts/template-init.min.js"></script>
